        ...
        private void serialPort1_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                if (textBox25.Text != "" && pictureBox3.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox25.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox27.Text != "" && pictureBox4.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox27.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox29.Text != "" && pictureBox5.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox29.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox21.Text != "" && pictureBox6.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox21.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox22.Text != "" && pictureBox7.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox22.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox28.Text != "" && pictureBox10.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox28.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox39.Text != "" && pictureBox11.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox39.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox37.Text != "" && pictureBox12.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox37.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox35.Text != "" && pictureBox13.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox35.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox31.Text != "" && pictureBox15.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox31.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox38.Text != "" && pictureBox16.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox38.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox34.Text != "" && pictureBox18.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox34.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
                ...
                if (textBox32.Text != "" && pictureBox19.Image == null)
                {
                    ...
                    //把数据存到数据库
                    // 创建INSERT语句
                    string sqls = "insert into ain(addres,dtimer,dianya,wendu,allyls,lanzao,lvzao,guizao,jiazao,yinzao,cdom,zhuodu,allswl,lanswl,lvswl,guiswl,jiaswl,yinswl,fo,fm,fv,fvfm,sigma,cn) VALUES ('" + textBox32.Text + "','" + today.ToString("yyyy-MM-dd") + "'," + ifs.Zdianya + "," + ifs.Zwendu + "," + ifs.Zallyelvsu + "," + ifs.Zlanzao + "," + ifs.Zlvzao + "," + ifs.Zguizao + "," + ifs.Zjiazao + "," + ifs.Zyinzao + "," + ifs.Zcdom + "," + ifs.Zzhuodu + "," + ifs.Zallswl + "," + ifs.Zlanzaoswl + "," + ifs.Zlvzaoswl + "," + ifs.Zguizaoswl + "," + ifs.Zjiazaoswl + "," + ifs.Zyinzaoswl + "," + ifs.ZF0 + "," + ifs.ZFm + "," + ifs.ZFv + "," + ifs.ZFvFm + "," + ifs.Zsigma + "," + ifs.Zcn + ")";
